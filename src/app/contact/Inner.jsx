                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-10">
                                <div className="single-contact-method">
                                    <div className="method">
                                        ...
                                        <div className="content w-220">
                                            <h5 className="info mb-0">
                                                <Link href="mailto:info@hostie.com">info@hostie.com</Link> <br />
                                                <Link href="mailto:support@hostie.com">support@hostie.com</Link>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-10">
                                <div className="single-contact-method">
                                    <div className="method">
                                        ...
                                        <div className="content w-220">
                                            <h5 className="info mb-0">
                                                <Link href="callto:11112542174">(555) 123-4567</Link> <br />
                                                <Link href="callto:11112542174">(111) 125- 42174</Link>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
