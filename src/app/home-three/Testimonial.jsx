...
function HomeThreeTestimonials() {
    return (
        <>
            <section className="rts-testimonial area-3 section__padding">
                ...
                <div className="testimonial-shape-area">
                    <img
                        className="one"
                    ...
                    <img
                        className="two"
                        src="assets/images/testimonials/bg-shape-4.svg"
                        alt=""
                    />
                </div>
            </section>
