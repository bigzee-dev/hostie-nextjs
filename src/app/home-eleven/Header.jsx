...
function HeaderEleven() {
    ...
    return (
        <>
            <header className={`rts-header top-0 header__style__eleven ${isSticky ? 'header-sticky' : ''}`}>
                    ...
                    <div className="row">
                        <div className="rts-header__wrapper">
                            ...
                            <div className="rts-header__logo">
                                <Link href="/" className="site-logo">
                                    <img
                                        ...
                                        src="/assets/images/logo/logo-11-top.svg"
                                        alt="Hostie"
                                    />
                                </Link>
                            </div>
                            ...
                            <div className="rts-header__right">
                                <div className="button-area d-flex gap-5 align-items-center">
                                    <div className="login-btn-has-dropdown">
                                        <Link href="#" className="login__link">
                                        <i className="fa-regular fa-user mr--10" />
                                            Login
                                        </Link>
                                    ...
                                    <Link
                                        href="https://hostie-whmcs.themewant.com/?systpl=hostie-demo10"
