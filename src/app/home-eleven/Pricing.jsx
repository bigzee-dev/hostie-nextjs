...
function HomeElevenPricing() {
    ...
    useEffect(() => {
        ...
        import('bootstrap').then((bootstrap) => {
          const tooltipTriggerList = Array.from(document.querySelectorAll('[data-bs-toggle="tooltip1"]'));
    ...
    return (
        <>
            <div className="rts-pricing-plan pricing__eleven section__padding">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="rts-section text-center">
                            ...
                            <p
                                className="rts-section__description w-450 "
                                data-sal="slide-down"
                                data-sal-delay={300}
                                data-sal-duration={800}
                            >
                            ...
                            <div className="col-lg-4 col-md-5">
                                <div className="rts-pricing-plan__tab color-primary">
                                    ...
                                    <div className="discount">
                                        <span className="line">
                                            <img
                                                src="assets/images/index-11/plan/offer__vector.svg"
                                                height={20}
                                                width={85}
                                                alt=""
                                            />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="card-plan">
                                        <div className="card-plan__package">
                                            <div className="icon">
                                                <img
                                                    src="assets/images/index-11/plan/basic.svg"
                                                    height={30}
                                                    width={30}
                                                    alt=""
                                                />
                                            ...
                                            {showMoreFeatures && (
                                                <ul className="card-plan__feature--list more__feature" style={{ display: 'flex' }}>
                                                    <li className="card-plan__feature--list-item">
                                                        ...
                                                        <span className="tooltip1" data-bs-toggle="tooltip1" data-bs-placement="bottom" title="Hostie offers generous hosting with 100GB SSD storage, providing ample space for your data and ensuring high-performance storage solutions."><i className="fa-light fa-circle-question"></i></span>
                                                    </li>
                                                    <li className="card-plan__feature--list-item">
                                                        <span className="text"><i className="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                                        <span className="tooltip1" data-bs-toggle="tooltip1" data-bs-placement="bottom" title="Secure your website with Hostie's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i className="fa-light fa-circle-question"></i></span>
                                                    </li>
                                                    <li className="card-plan__feature--list-item">
                                                        <span className="text"><i className="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                                        <span className="tooltip1" data-bs-toggle="tooltip1" data-bs-placement="bottom" title="Hostie guarantees 99% uptime, ensuring your website is consistently available and reliable for visitors around the clock."><i className="fa-light fa-circle-question"></i></span>
                                                    </li>
                                                    <li className="card-plan__feature--list-item">
                                                        <span className="text"><i className="fa-regular fa-xmark"></i> Web Application Firewall</span>
                                                        <span className="tooltip1" data-bs-toggle="tooltip1" data-bs-placement="bottom" title="Enhance your website's security with Hostie's Web Application Firewall, protecting against online threats and ensuring a safe online environment."><i className="fa-light fa-circle-question"></i></span>
                                                    </li>
                                                </ul>
                                            )}
                                        </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="card-plan">
                                        <div className="card-plan__package">
                                            <div className="icon">
                                                <img
                                                    src="assets/images/index-11/plan/premium.svg"
                                                    height={30}
                                                    width={30}
                                                    alt=""
                                                />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="card-plan active">
                                        <div className="card-plan__package">
                                            <div className="icon">
                                                <img
                                                    src="assets/images/index-11/plan/business.svg"
                                                    height={30}
                                                    width={30}
                                                    alt=""
                                                />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6">
                                    <div className="card-plan ">
                                        <div className="card-plan__package">
                                            <div className="icon">
                                                <img
                                                    src="assets/images/index-11/plan/cloud.svg"
                                                    height={30}
                                                    width={30}
                                                    alt=""
                                                />
...
export default HomeElevenPricing