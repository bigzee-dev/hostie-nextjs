...
function HomeTwoPricing({ className }) {
    ...
    return (
        <div className={`rts-pricing-plan pricing__section section__rounded section__padding ${className}`}>
            <div className="container">
                    ...
                    <div className="col-xl-6">
                        <div className="rts-section text-center">
                            ...
                            <p
                                ...
                                data-sal-duration={800}
                            >
                                shared hosting is the easiest, most economical
                            </p>
                        </div>
                    </div>
                </div>
                <div className="row justify-content-center">
                    <div className="col-xl-4 col-lg-4 col-md-5">
                        <div className="rts-pricing-plan__tab">
                            <div className="tab__button">
                                <div className="tab__button__item">
                                    <button
                                        className={`tab__btn ${activeTab === 'monthly' ? 'active' : ''}`}
                                        onClick={() => handleTabClick('monthly')}
                                    >
                                        monthly
                                    </button>
                                    <button
                                        className={`tab__btn ${activeTab === 'yearly' ? 'active' : ''}`}
                ...
                {/* PRICING PLAN */}
                <div
                    className={`tab__content ${activeTab === 'monthly' ? 'open' : ''}`}
                    id="monthly"
                    style={{ display: activeTab === 'monthly' ? 'block' : 'none' }}
                >
                    <div className="row monthly g-30">
                        {/* single pricing plan */}
                        <div className="col-lg-4 col-md-6">
                            <div className="single-plan has-box-shadow">
                                <div className="single-plan__content">
                                    <div className="plan-icon">
                                        ...
                                        >
                                            ...
                                            <defs>
                                                ...
                                                >
                                                    <stop offset="10%" stopColor="#9999FF" />
                                                    <stop offset={1} stopColor="#2B2BFF" />
                                                </linearGradient>
                                                <linearGradient
                                                    id="paint1_linear_193_834"
                                                    x1="19.9725"
                                                    y1="-6.84369e-06"
                                                    x2="19.9725"
                                                    y2="39.0008"
                                    ...
                                    <p className="description">Added privacy and security features</p>
                                    <div className="border-separator" />
                                    <div className="plan-feature">
                                        <ul className="plan-feature__list">
                                            <li>
                                                <span>
                                                    <i className="fa-solid fa-check" /> Free Domain ($9.99 value)
                                                </span>
                                            </li>
                                            <li>
                                                <span>
                                                    <i className="fa-solid fa-check" /> Staging Environment
                                                </span>
                                            </li>
                                            <li>
                                                <span>
                                                    <i className="fa-solid fa-check" /> 24/7/365 Support
                                                </span>
                                            </li>
                                            <li>
                                                <span>
                                                    <i className="fa-solid fa-xmark" /> Free Domain ($9.99 value)
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                    <button className="buy__plan btn__two">Price: $12.36</button>
                                </div>
                            </div>
                        </div>
                        {/* single pricing plan */}
                        <div className="col-lg-4 col-md-6">
                            <div className="single-plan has-box-shadow active">
                                <div className="single-plan__content">
                                    <div className="plan-icon">
                                        <svg
                                            width={43}
                                        ...
                                        >
                                            ...
                                            <defs>
                                                <linearGradient
                                                    ...
                                                    gradientUnits="userSpaceOnUse"
                                                >
                                                    <stop offset="10%" stopColor="#F0B400" />
                                                    <stop offset={1} stopColor="#FFE1B1" />
                                                </linearGradient>
                                            </defs>
                                        </svg>
                                    </div>
                                    ...
                                    <button className="buy__plan btn__two">Price: $99.36</button>
                                </div>
                            </div>
                        </div>
                        {/* single pricing end */}
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-plan has-box-shadow">
                                <div className="single-plan__content">
                                    ...
                                    <h4 className="plan-title">Cloud Startup</h4>
                                    <p className="description">Added privacy and security features</p>
                                    <div className="border-separator" />
                                    <div className="plan-feature">
                                        <ul className="plan-feature__list">
                                    ...
                                    <button className="buy__plan btn__two">Price: $55.36</button>
                                </div>
                            </div>
                        </div>
                        {/* single pricing end */}
                ...
                <div
                    className={`tab__content ${activeTab === 'yearly' ? 'open' : ''}`}
                    id="yearly"
                    style={{ display: activeTab === 'yearly' ? 'block' : 'none' }}
                >
                    <div className="row yearly g-30">
                        {/* single pricing plan */}
                        <div className="col-lg-4 col-md-6">
                            <div className="single-plan has-box-shadow">
                                <div className="single-plan__content">
                                    <div className="plan-icon">
                                        ...
                                        >
                                            <path
                                                d="M36.5877 20.7647L37.5973 16.9971C38.7756 12.5992 39.3648 10.4002 38.9211 8.49722C38.5709 6.99464 37.7828 5.6297 36.6567 4.57499C35.2305 3.23924 33.0314 2.65003 28.6336 1.4716C24.2357 0.293177 22.0366 -0.296027 20.1337 0.14769C18.6311 0.498029 17.2661 1.28608 16.2115 2.41218C15.0678 3.63324 14.4714 5.42081 13.5839 8.66997C13.4349 9.21563 13.2775 9.80292 13.1081 10.4352L12.0986 14.2028C10.9201 18.6007 10.3309 20.7996 10.7746 22.7027C11.125 24.2053 11.913 25.5703 13.0391 26.625C14.4653 27.9607 16.6643 28.5498 21.0623 29.7284C25.0263 30.7905 27.2037 31.374 28.9884 31.1538C29.1838 31.1298 29.3743 31.0961 29.5621 31.0522C31.0646 30.7019 32.4296 29.9138 33.4843 28.7878C34.82 27.3616 35.4093 25.1627 36.5877 20.7647Z"
                                                fill="url(#paint0_linear_193_835)"
                                            />
                                            <path
                                                d="M2.34746 24.7972L3.35698 28.5649C4.53541 32.9628 5.12461 35.1617 6.46036 36.5879C7.51507 37.714 8.88002 38.5021 10.3826 38.8523C12.2856 39.296 14.4845 38.7069 18.8825 37.5285C23.2803 36.35 25.4794 35.7608 26.9056 34.4251C27.024 34.3141 27.1385 34.1999 27.2494 34.0825C26.5977 34.0277 25.9402 33.9227 25.2721 33.7899C23.9145 33.52 22.3015 33.0878 20.3938 32.5767L20.1371 32.5078C18.0615 31.9516 16.3272 31.4861 14.9424 30.9859C13.4862 30.4597 12.163 29.8113 11.0395 28.7589C9.49107 27.3087 8.40752 25.4318 7.92577 23.3659C7.57621 21.8666 7.67614 20.3965 7.94868 18.8722C8.20986 17.4117 8.67893 15.6613 9.24091 13.5641L10.3198 9.53784C6.57424 10.5468 4.60277 11.1438 3.28804 12.3752C2.16193 13.4299 1.37388 14.7948 1.02354 16.2973C0.579827 18.2003 1.16903 20.3992 2.34746 24.7972Z"
                                                fill="url(#paint1_linear_193_835)"
                                            />
                                            <defs>
                                                <linearGradient
                                                    id="paint0_linear_193_835"
                                                    x1="19.9725"
                                                    y1="-1.61164e-06"
                                                    x2="19.9725"
                                                    y2="39.0008"
                                    ...
                                    <button className="buy__plan btn__two">Price: $144.36</button>
                                </div>
                            </div>
                        </div>
                        {/* single pricing plan */}
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-plan has-box-shadow active">
                                <div className="single-plan__content">
                                    ...
                                    <h5 className="plan-title">Premium Plan</h5>
                                    <p className="description">Added privacy and security features</p>
                                    <div className="border-separator" />
                                    <div className="plan-feature">
                                        <ul className="plan-feature__list">
                                    ...
                                    <button className="buy__plan btn__two">Price: $1000.36</button>
                                </div>
                            </div>
                        </div>
                        {/* single pricing end */}
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-plan has-box-shadow">
                                <div className="single-plan__content">
                                    <div className="plan-icon">
                                        ...
                                        >
                                            <path
                                                ...
                                                clipRule="evenodd"
                                                d="M18.3567 7.52352C16.5762 6.55271 14.4246 6.55271 12.6443 7.52352L3.10995 12.7224C1.19287 13.7677 0 15.7768 0 17.9605V27.78C0 29.9636 1.19287 31.9728 3.10995 33.018L12.6443 38.2169C14.4246 39.1876 16.5762 39.1876 18.3567 38.2169L27.891 33.018C29.8081 31.9728 31.001 29.9636 31.001 27.78V17.9605C31.001 15.7768 29.8081 13.7677 27.891 12.7224L18.3567 7.52352ZM15.5009 16.9041C14.9359 16.9041 14.5581 17.5818 13.8023 18.9375L13.6069 19.2883C13.3923 19.6736 13.2849 19.8661 13.1174 19.9931C12.95 20.1202 12.7416 20.1676 12.3245 20.2618L11.9449 20.3477C10.4773 20.6798 9.74359 20.8457 9.56902 21.4071C9.39445 21.9685 9.89466 22.5534 10.8951 23.7234L11.1539 24.0261C11.4382 24.3584 11.5803 24.5246 11.6444 24.7303C11.7082 24.9359 11.6867 25.1576 11.6438 25.6013L11.6046 26.005C11.4534 27.566 11.3778 28.3463 11.8347 28.6934C12.2919 29.0402 12.9788 28.724 14.3528 28.0914L14.7082 27.9277C15.0988 27.7479 15.2939 27.6581 15.5009 27.6581C15.7079 27.6581 15.903 27.7479 16.2936 27.9277L16.649 28.0914C18.023 28.724 18.7099 29.0402 19.1671 28.6934C19.6241 28.3463 19.5483 27.566 19.3972 26.005L19.358 25.6013C19.3151 25.1576 19.2936 24.9359 19.3574 24.7303C19.4215 24.5246 19.5637 24.3584 19.8478 24.0261L20.1068 23.7234C21.1071 22.5534 21.6075 21.9685 21.4328 21.4071C21.2582 20.8457 20.5244 20.6798 19.0569 20.3477L18.6773 20.2618C18.2603 20.1676 18.0518 20.1202 17.8844 19.9931C17.7169 19.8661 17.6095 19.6736 17.395 19.2883L17.1995 18.9375C16.4438 17.5818 16.0659 16.9041 15.5009 16.9041Z"
                                                fill="url(#paint0_linear_197_963)"
                                            />
                                            <path
                                                d="M13.5122 0H17.4897C21.2396 0 23.1146 -1.18537e-07 24.2795 1.16497C25.4445 2.32992 25.4445 4.2049 25.4445 7.95486V7.9906L19.7848 4.90449C17.1142 3.44831 13.8869 3.44829 11.2163 4.90449L5.55737 7.99016V7.95486C5.55737 4.2049 5.55737 2.32992 6.72234 1.16497C7.88729 -1.18537e-07 9.76227 0 13.5122 0Z"
                                                fill="url(#paint1_linear_197_963)"
                                            />
                                            <defs>
                                                <linearGradient
                                                    id="paint0_linear_197_963"
                                                    x1="15.5009"
                                                    y1="-1.1999e-05"
                                                    x2="15.5009"
                                                    y2="38.945"
                                    ...
                                    <h5 className="plan-title">Cloud Startup</h5>
                                    <p className="description">Added privacy and security features</p>
                                    <div className="border-separator" />
                                    <div className="plan-feature">
                                        <ul className="plan-feature__list">
                                    ...
                                    <button className="buy__plan btn__two">Price: $448.36</button>
                                </div>
                            </div>
                        </div>
                        {/* single pricing end */}
