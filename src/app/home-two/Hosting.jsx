...
function HomeTwoHosting() {
    return (
        <>
            <section className="rts-hosting-feature cultured__white section__padding">
                <div className="container">
                    <div className="row align-items-center justify-content-sm-center">
                        <div className="col-xl-6 col-lg-6 col-md-10 col-sm-10 order-2 order-lg-0">
                            <div className="rts-hosting-feature__content">
                                <div className="rts-section__two">
                                    ...
                                    >
                                        Have Complete Peace of Mind with Migration
                                    </h2>
                                    <p
                                ...
                                <div className="hosting-feature mx-0">
                                    <ul>
                                        <li
                                            data-sal="slide-up"
                                            data-sal-delay={800}
                                            data-sal-duration={800}
                                        >
                                            <div className="hosting-feature__single feature__one">
                                                <div className="icon">
                                                    <svg
                                                        width={26}
                                                        height={22}
                                                    ...
                                                    >
                                                        <path
                                                            ...
                                                            fill="url(#paint0_linear_215_8401)"
                                                        />
                                                        <path
                                                ...
                                                <p className="feature-text">Maximize website loading speed</p>
                                            </div>
                                        </li>
                                        <li
                                            data-sal="slide-left"
                                            ...
                                            data-sal-duration={800}
                                        >
                                            <div className="hosting-feature__single feature__two">
                                                <div className="icon">
                                                    <svg
                                                        width={26}
                                                        height={26}
                                                    ...
                                                    >
                                                        <path
                                                            ...
                                                            fill="url(#paint0_linear_215_8427)"
                                                        />
                                                        <path
                                                        ...
                                                        <defs>
                                                            ...
                                                            <linearGradient
                                                                ...
                                                                gradientUnits="userSpaceOnUse"
                                                            >
                                                                <stop offset="10%" stopColor="#ADDCFF" />
                                                ...
                                                <p className="feature-text">Enjoy optimized performance</p>
                                            </div>
                                        </li>
                                        <li
                                            data-sal="slide-down"
                                            ...
                                            data-sal-duration={800}
                                        >
                                            <div className="hosting-feature__single feature__three">
                                                <div className="icon">
                                                    <svg
                                                        width={25}
                                                        height={25}
                                                    ...
                                                    >
                                                        <path
                                                            ...
                                                            fill="url(#paint0_linear_215_8444)"
                                                        />
                                                        <path
                                                            ...
                                                            fill="url(#paint1_linear_215_8444)"
                                                        />
                                                        <defs>
                                                            <linearGradient
                                                                id="paint0_linear_215_8444"
                                                                x1="12.5"
                                                                y1="22.0216"
                                                                x2="12.5"
                                                                y2="0.368652"
                                                                gradientUnits="userSpaceOnUse"
                                                            >
                                                                <stop offset="10%" stopColor="#049A91" />
                                                                <stop offset={1} stopColor="#0CFFAF" />
                                                            </linearGradient>
                                                            <linearGradient
                                                                id="paint1_linear_215_8444"
                                                                x1="12.5"
                                                                y1={25}
                                                                x2="12.5"
                                                                y2={0}
                                                                gradientUnits="userSpaceOnUse"
                                                            >
                                                                <stop offset={0} stopColor="#71FFCC" />
                                                                <stop offset="0.5028" stopColor="#EAF6FF" />
                                                                <stop offset={1} stopColor="#EAF6FF" />
                                                            </linearGradient>
                                                        </defs>
                                                ...
                                                <p className="feature-text">Reduce website response times</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-10 col-sm-10 mb-5 mb-lg-0">
                            <div
                                className="rts-hosting-feature__image"
                                data-sal="slide-left"
                                data-sal-delay={600}
                                data-sal-duration={800}
                            >
                                <img
                                    src="assets/images/hosting/hosting__feature.svg"
                                    alt="hosting feature"
                                />
                            </div>
                        </div>
