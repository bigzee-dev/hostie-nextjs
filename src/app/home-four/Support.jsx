...
function HomeFourSupport ({ className, children }) {
    return (
        <>
            <div className={`rts-support ${className}`}>
                <div className="container">
                    <div className="row">
                        <div className={`rts-support__wrapper ${children}`}>
...
export default HomeFourSupport