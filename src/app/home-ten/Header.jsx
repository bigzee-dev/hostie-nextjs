                            ...
                            <div className="rts-ht__wrapper">
                                <div className="rts-ht__email">
                                    <Link href="mailto:info@hostie.com">
                                            <img src="/assets/images/icon/email.svg" alt="Email Icon" className="icon" />
                                            contact@hostie.com
                                    </Link>
                                </div>
                                <div className="rts-ht__promo">
                                    <p>
                                        <img src="/assets/images/icon/tag--group.svg" alt="Tag Icon" className="icon" />{" "}
                                ...
                                <div className="rts-ht__links">
                                    <div className="live-chat-has-dropdown">
                                        <Link href="/support" className="live__chat">
                                            <img src="/assets/images/icon/forum.svg" alt="Forum Icon" className="icon" />
                                            Live Chat
                                        </Link>
                                    </div>
                                    <div className="login-btn-has-dropdown">
                                        <Link href="#" className="login__link">
                                            <img src="/assets/images/icon/person.svg" alt="Person Icon" className="icon" />
                                            Login
                                        </Link>
                            ...
                            <div className="rts-header__wrapper">
                                ...
                                <div className="rts-header__logo">
                                    <Link href="/" className="site-logo">
                                        <img className="logo-white" src="/assets/images/logo/logo-1.svg" alt="Hostie Logo White" />
                                        <img className="logo-dark" src="/assets/images/logo/logo-4.svg" alt="Hostie Logo Dark" />
                                    </Link>
                                </div>
