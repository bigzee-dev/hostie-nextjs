...
function HomeTenHostingFeature() {
    return (
        <>
            <div className="rts-hosting-feature-four section__padding">
                    ...
                    <div className="row">
                        <div className="rts-section section-style-two">
                            <div className="rts-section__two">
                                ...
                                >
                                    Explore Our MERN Hosting Features
                                </h2>
                            </div>
                            <div className="rts-section-description w-550">
                                <p
                                    ...
                                    data-sal-duration={800}
                                >
                                    Hosting a MERN (MongoDB, Express.js, React.js, Node.js) stack
                                    involves specialized features to ensure optimal performance,
                                    scalability, and ease of deployment. Below are some key features
                                    typically offered by hosting providers tailored for MERN
                                    applications:
                                </p>
                                <Link href="/pricing">
                                    View all feature <i className="fa-solid fa-chevron-right" />
                                </Link>
                            </div>
                        </div>
                    </div>
...
export default HomeTenHostingFeature