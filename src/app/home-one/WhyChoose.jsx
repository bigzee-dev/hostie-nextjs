                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5 order-change">
                            <div className="rts-whychoose__content">
                                ...
                                {/* single content*/}
                                <div className="single" data-sal="slide-right" data-sal-delay={400} data-sal-duration={800} >
                                ...
                                {/* single content*/}
                                <div className="single" data-sal="slide-right" data-sal-delay={500} data-sal-duration={800}>
                                    <div className="single__image">
                        ...
                        <div className="col-lg-6 offset-lg-1">
                            <div className="rts-whychoose__image">
                                ...
                                <img src="assets/images/paper-plane.svg" alt="" className="shape one bottom-top" />
                                <img src="assets/images/wifi.svg" alt="" className="shape two right-left" />
                            </div>
                        </div>
                    </div>
                </div>
