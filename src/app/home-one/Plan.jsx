                                        ...
                                        <tr>
                                            ...
                                            <th className="package__item">
                                                <div className="package__item__info">
                                                    ...
                                                    <form action="#">
                                                        ...
                                                        <button type="submit" aria-label="buy package" className="primary__btn primary__bg buy__now">
                                                            By Now
                                                        </button>
                                                    </form>
                                                </div>
                                            ...
                                            <th className="package__item">
                                                ...
                                                <div className="package__item__info">
                                                    ...
                                                    <span className="start">Starting at $3.75/mo*</span>
                                                    <form action="#">
                                                        <select name="select" id="select1" className="price__select" >
                                                            <option value={1}>$3.75/mo</option>
                                                            <option value={1}>$10.75/yr</option>
                                                        </select>
                                                        <button type="submit" aria-label="buy package" className="primary__btn primary__bg buy__now" >
                                            ...
                                            <th className="package__item">
                                                <div className="package__item__info">
                                                    ...
                                                    <span className="start">Starting at $3.75/mo*</span>
                                                    <form action="#">
                                                        <select name="select" id="select2" className="price__select" >
                                                            <option value={1}>$3.75/mo</option>
                                                            <option value={1}>$10.75/yr</option>
                                                        </select>
                                                        <button type="submit" aria-label="buy package" className="primary__btn primary__bg buy__now" >
