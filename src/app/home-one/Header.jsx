                        ...
                        <div className="row">
                            <div className="rts-ht__wrapper">
                                <div className="rts-ht__email">
                                    ...
                                    <Image src="/assets/images/icon/email.svg" alt="Email" width={20} height={20} />
                                            contact@hostie.com
                                    </Link>
                                </div>
                                <div className="rts-ht__promo">
                                    <p>
                                    <Image src="/assets/images/icon/tag--group.svg" alt="Email" width={20} height={20} />
                                ...
                                <div className="rts-ht__links">
                                    <div className="live-chat-has-dropdown">
                                        <Link href="/support" className="live__chat">
                                        <Image src="/assets/images/icon/forum.svg" alt="Email" width={20} height={20} />
                                            Live Chat
                                        </Link>
                                    </div>
                                    <div className="login-btn-has-dropdown">
                                        <Link href="#" className="login__link">
                                        <Image src="/assets/images/icon/person.svg" alt="Email" width={20} height={20} />
                                            Login
                                        </Link>
                        ...
                        <div className="rts-header__wrapper">
                            ...
                            <div className="rts-header__logo">
                                <Link href="/" className="site-logo">
                                    <Image className="logo-white" src="/assets/images/logo/logo-1.svg" width={136} height={30}alt="Hostie Logo White" />
                                    <Image className="logo-dark" src="/assets/images/logo/logo-4.svg" width={136} height={30} alt="Hostie Logo Dark" />
                                </Link>
                            </div>
