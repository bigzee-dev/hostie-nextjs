...
function HomeSevenTestimonials() {
    return (
        <>
            <section className="rts-testimonial game-testimonial">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <Swiper
                                ...
                                className="testimonial__slider--first rts-testimonial__slider"
                                slidesPerView={3}
                                spaceBetween={30}
                                speed={1000}
                                loop={true}
...
export default HomeSevenTestimonials