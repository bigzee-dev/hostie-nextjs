...
function HomeSevenPricing() {
    ...
    return (
        <>
            <div className="rts-pricing-plan game-pricing">
                <div className="container">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-5">
                            <div className="rts-pricing-plan__tab">
                                ...
                                <div className="discount">
                                    <span className="line">
                                        <img
                                            src="assets/images/pricing/offer__vactor-2.svg"
                                            height={20}
                                            width={85}
                                            alt=""
                                        />
                    ...
                    <div className={`tab__content ${activeTab === "monthly" ? "open" : ""}`}
                        ...
                        <div className="row monthly g-30">
                                        ...
                                        <div className="plan-icon">
                                            ...
                                            >
                                                ...
                                                <defs>
                                                    ...
                                                    >
                                                        <stop offset="10%" stopColor="#FBB231" />
                            ...
                            {/* single pricing plan */}
                            <div className="col-lg-4 col-md-6">
                                <div className="single-plan active">
                                    <div className="single-plan__content">
                                        <div className="plan-icon">
                                            <svg
                                                width={43}
...
export default HomeSevenPricing