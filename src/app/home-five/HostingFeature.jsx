...
function HomeFiveHostingFeature() {
    return (
        <>
            <div className="rts-hosting-feature-four feature-five pt--120">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="rts-section text-center section-style-two">
                    ...
                    {/* feature lsit */}
                    <div className="row g-30 justify-content-md-center">
                        <div
                    ...
                    <div
                        className="feature-btn-area"
                        data-sal="slide-down"
                        data-sal-delay={500}
                        data-sal-duration={800}
                    >
                        <Link href="/pricing" className="plan__btn">
...
export default HomeFiveHostingFeature